/* =====================================================================
   ...
   in the background. Everything else (HTML, CSS, the engine, language JSON)
   is left to the normal network + HTTP cache, so code and text stay fresh.

   Bump VERSION to discard old caches.
   ===================================================================== */
const VERSION = "df-cache-v1";
const HEAVY = /-data\.js$|\/images\//;
